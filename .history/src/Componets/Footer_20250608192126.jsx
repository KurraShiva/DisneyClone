      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-[#1f2a48] mt-12 pt-6 px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 text-white text-xl">
            <a href="https://facebook.com/disneyplus" target="_blank" rel="noreferrer" className="transition"><FaFacebookF /></a>
            <a href="https://twitter.com/disneyplus" target="_blank" rel="noreferrer" className=" transition"><FaTwitter /></a>
            <a href="https://instagram.com/disneyplus" target="_blank" rel="noreferrer" className=" transition"><FaInstagram /></a>
          </div>
        </div>
      </div>
    </footer>
