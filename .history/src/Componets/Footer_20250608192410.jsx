        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5 border-t border-[#1f2a48] pt-12 px-4">
          ...
          <div>
            ...
            <select className="w-full bg-white/10 text-white px-3 py-2 rounded-md border border-[#2e3a5e] text-sm">
              <option>India</option>
              <option className="bg-white/10  text-white px-3 py-2 rounded-md border border-[#2e3a5e] text-sm"  text-white>United States</option>
              <option  className="bg-white/10  text-white px-3 py-2 rounded-md border border-[#2e3a5e] text-sm">UK</option>
            </select>
          </div>
        </div>
