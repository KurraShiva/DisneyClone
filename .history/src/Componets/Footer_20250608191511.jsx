    ...
    <footer className="bg-gradient-to-b from-[#0b1120] to-[#040714] text-white py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-[#b0b8d4] text-lg max-w-xl mx-auto mb-6">
        ...
        {/* Main Grid */}
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5 border-t border-[#1f2a48] pt-12">
          {/* Logo + Social */}
          <div>
            <img
        ...
        {/* Copyright */}
        <div className="text-center text-xs text-[#5c677d] mt-14">
