...
<div>
  ...
  <select
    className="w-full bg-white/20 backdrop-blur-sm text-white px-4 py-3 rounded-lg mb-5 border border-transparent hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition text-sm font-medium cursor-pointer"
  >
  ...
  <select
    className="w-full bg-white/20 backdrop-blur-sm text-white px-4 py-3 rounded-lg border border-transparent hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition text-sm font-medium cursor-pointer"
  >
    <option>India</option>
